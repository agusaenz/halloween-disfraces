...
<body>
    <div class="container mt-5">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <button class="btn btn-secondary move-left" id="clearFiltersBtn">Borrar Filtros</button>
            </div>
            <div class="col-md-3">
                <button class="btn btn-success btn-lg-custom" id="addClientBtn" data-toggle="modal" data-target="#addModal">Agregar Cliente</button>
            </div>
        </div>
        <div class="row mt-3">
            <div class="col-md-12">
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="addModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
                    <button type="button" class="btn btn-primary" id="addClient">Agregar Cliente</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function(){
            let people = [
                { id: 1, apellido: 'Pérez', nombre: 'Juan', dni: '12345678', email: 'juan@example.com', telefono: '111-222-333', direccion: 'Calle 1' },
                { id: 2, apellido: 'Gómez', nombre: 'María', dni: '87654321', email: 'maria@example.com', telefono: '444-555-666', direccion: 'Calle 2' },
                { id: 3, apellido: 'Rodríguez', nombre: 'Luis', dni: '11223344', email: 'luis@example.com', telefono: '777-888-999', direccion: 'Calle 3' },
                { id: 4, apellido: 'Martínez', nombre: 'Ana', dni: '55667788', email: 'ana@example.com', telefono: '333-222-111', direccion: 'Calle 4' },
                { id: 5, apellido: 'López', nombre: 'Carlos', dni: '99887766', email: 'carlos@example.com', telefono: '555-444-333', direccion: 'Calle 5' }
            ];
    ...
    people.forEach(person => {
        if ((person.apellido.toLowerCase().includes(filterName.toLowerCase()) || person.nombre.toLowerCase().includes(filterName.toLowerCase())) &&
